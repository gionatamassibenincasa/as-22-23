...
In considerazione delle problematiche descritte in <<sec:analisiProblematiche>>, l'insegnamento in ambienti di apprendimento digitale deve soddisfare le seguenti specifiche:
